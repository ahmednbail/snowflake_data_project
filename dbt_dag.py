...
DBT_PROJECT_DIR = "D:\Ahmed\Projects\Data_EngineerProject\snowflake_data_project"  # Update this path

# Task 1: Run dbt models
dbt_run = BashOperator(
    task_id='dbt_run',
    bash_command=f'cd {D:\Ahmed\Projects\Data_EngineerProject\snowflake_data_project} && dbt run',
    dag=dag,
)
